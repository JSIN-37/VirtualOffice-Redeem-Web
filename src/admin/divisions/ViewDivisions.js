...
import { addDivision } from './functions'
...
export default function ViewDivisions() {
    ...
    return (
        ...
        <div>
            <button onClick={()=>{setRenderAddDivision(true)}}>Add division</button>
        ...
        {renderAddDivision && <>
            ...
            <InputField type={`text`} placeholder={`description`} input={divisionDescription}/>
